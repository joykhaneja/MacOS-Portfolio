...
const bootLines = [
  ...
  '[ OK ] Starting Lumon Desktop Manager',
  '[ OK ] Started Lumon Desktop Manager',
  '[ OK ] Starting Print Spooler',
  '[ OK ] Started Print Spooler',
  '[ OK ] Mounting /mnt/media',
  '[ERROR] Failed to mount /mnt/media: No such device',
  '[ OK ] Starting Lumon Icon Theme Cache',
  '[ OK ] Started Icon Theme Cache',
  ...
  '[ OK ] Started Package Manager',
  '[ OK ] Starting Hardware Monitor',
  '[ OK ] Started Hardware Monitor',
  '[ OK ] Starting Security Scanner',
  '[ OK ] Started Security Scanner',
  '[ OK ] Starting Database Service',
  '[ OK ] Started Database Service',
  '[ OK ] Starting Font Cache',
  '[ OK ] Started Font Cache',
  '[ OK ] Reached target Graphical Interface',
  '[ OK ] Loading Lumon Workspace Environment',
  '[ OK ] Applying Theme: Dark (Lumon Default)',
  '[ OK ] Initializing Workspace: Macrodata Refinement',
  '[ OK ] Starting Project Kernel Indexing',
  '[ OK ] Opening Window: Terminal',
  '[ OK ] Opening Window: System Preferences',
  '[ OK ] Opening Window: Finder',
  '[ OK ] Opening Window: Resume',
  '[ OK ] Injecting Joy Khaneja Portfolio Profile',
  '[ OK ] Initializing Fake File System',
  '[ OK ] Syncing Timezone: IST',
  '[ OK ] Parsing Desktop Icons',
  '[ OK ] Mounting Desktop Environment',
  '[ OK ] Finalizing User Session',
  '[ OK ] Environment: Ready',
  '[ OK ] Started Portfolio Desktop Environment',
  '[ERROR] Failed to locate external monitor',
  '[ OK ] Finished booting. Welcome, Joy.'
];
